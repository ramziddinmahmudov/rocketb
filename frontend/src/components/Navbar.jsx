...
export default function Navbar({ currentTab, setTab }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-[#050A18]/90 backdrop-blur-xl border-t border-white/5 pt-3 px-6" style={{ paddingBottom: 'calc(24px + env(safe-area-inset-bottom, 0px))' }}>
